...
namespace KMGame
{
    ...
    public class CorgiController : MonoBehaviour
    {
        ...
        [Header("Collisions")]
        [Information("You need to define what layer(s) this character will consider a walkable platform/moving platform etc. " +
              "By default, you want Platforms, MovingPlatforms, OneWayPlatforms, MovingOneWayPlatforms, in this order.", InformationType.Info, false)]
        ...
        [Header("Stickiness")]
        [Information("Here you can define whether or not you want your character stick to slopes when walking down them, " +
              "and how long the raycast handling that should be (0 means automatic length).", InformationType.Info, false)]
        ...
        [Header("Safety")]
        [Information("Here you can authorize your controller to start rotated. This will change its gravity direction. " +
