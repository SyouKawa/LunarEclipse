...
namespace KMGame
{
    ...
    public class CameraController : MonoBehaviour
    {
        ...
        [Information("Here you can define how fast the camera goes back to the player, and how fast it moves generally.", InformationType.Info, false)]
        ...
        [Space(10)]
        [Header("Camera Zoom")]
        [Information("Determine here the min and max zoom, and the zoom speed. By default the engine will zoom out when your character is going at full speed, and zoom in when you slow down (or stop). Note that if you turn Pixel Perfect on, zoom will be disabled.", InformationType.Info, false)]
        [Range(1, 20)]
        ...
        [Information("Here you can decide to have a pixel perfect camera, which will resize the camera's orthographic size on start to match the desired size and pixel per units.", InformationType.Info, false)]
        ...
        [Information("If EnableEffectsOnMobile is set to false, all Cinematic Effects on the camera will be removed at start on mobile targets.", InformationType.Info, false)]
