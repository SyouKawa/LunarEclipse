...
namespace KMGame
{
    ...
    public class InputManager : MMSingleton<InputManager>
    {
        ...
        protected virtual void InitializeButtons()
        {
            ...
            ButtonList.Add(JumpButton = new MMInput.IMButton("Jump", JumpButtonDown, JumpButtonPressed, JumpButtonUp));
            ButtonList.Add(SwimButton = new MMInput.IMButton("Swim", SwimButtonDown, SwimButtonPressed, SwimButtonUp));
            ButtonList.Add(GlideButton = new MMInput.IMButton("Glide", GlideButtonDown, GlideButtonPressed, GlideButtonUp));
            ButtonList.Add(InteractButton = new MMInput.IMButton("Interact", InteractButtonDown, InteractButtonPressed, InteractButtonUp));
            ButtonList.Add(JetpackButton = new MMInput.IMButton("Jetpack", JetpackButtonDown, JetpackButtonPressed, JetpackButtonUp));
            ButtonList.Add(RunButton = new MMInput.IMButton("Run", RunButtonDown, RunButtonPressed, RunButtonUp));
            ButtonList.Add(DashButton = new MMInput.IMButton("Dash", DashButtonDown, DashButtonPressed, DashButtonUp));
            ButtonList.Add(FlyButton = new MMInput.IMButton("Fly", FlyButtonDown, FlyButtonPressed, FlyButtonUp));
            ButtonList.Add(ShootButton = new MMInput.IMButton("Shoot", ShootButtonDown, ShootButtonPressed, ShootButtonUp));
            ButtonList.Add(SecondaryShootButton = new MMInput.IMButton("SecondaryShoot", SecondaryShootButtonDown, SecondaryShootButtonPressed, SecondaryShootButtonUp));
            ButtonList.Add(ReloadButton = new MMInput.IMButton("Reload", ReloadButtonDown, ReloadButtonPressed, ReloadButtonUp));
            ButtonList.Add(SwitchWeaponButton = new MMInput.IMButton("SwitchWeapon", SwitchWeaponButtonDown, SwitchWeaponButtonPressed, SwitchWeaponButtonUp));
            ButtonList.Add(PauseButton = new MMInput.IMButton("Pause", PauseButtonDown, PauseButtonPressed, PauseButtonUp));
            ButtonList.Add(PushButton = new MMInput.IMButton("Push", PushButtonDown, PushButtonPressed, PushButtonUp));
            ButtonList.Add(SwitchCharacterButton = new MMInput.IMButton("SwitchCharacter", SwitchCharacterButtonDown, SwitchCharacterButtonPressed, SwitchCharacterButtonUp));
            ButtonList.Add(TimeControlButton = new MMInput.IMButton("TimeControl", TimeControlButtonDown, TimeControlButtonPressed, TimeControlButtonUp));
        }
